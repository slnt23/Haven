class MedicalKnowledgeTool:
    SYMPTOM_DATABASE: dict[str, list[dict[str, str]]] = {
        "headache": [
            {
                ...
                "symptoms": "bilateral pressing pain, mild to moderate",
                "suggestion": "Rest, hydration, OTC pain relievers",
            },
            {
                "condition": "Migraine",
                "symptoms": "unilateral throbbing pain, photophobia, nausea",
                "suggestion": "Dark room rest, consult neurologist if severe",
            },
            {
                "condition": "Sinusitis",
                "symptoms": "facial pressure, nasal congestion, fever",
        ...
        "fever": [
            {
                ...
                "symptoms": "mild fever, runny nose, sore throat",
            ...
            },
            {
                ...
                "symptoms": "persistent high fever, localized pain",
        ...
        "chest pain": [
            {
                "condition": "Angina",
                "symptoms": "chest pressure, radiating to left arm, exertion-induced",
                "suggestion": "Immediate medical evaluation, ECG required",
            },
            {
                "condition": "GERD",
                "symptoms": "burning sensation, worse after meals, lying down",
                "suggestion": "Antacids, dietary changes, consult gastroenterologist",
            },
            {
                "condition": "Costochondritis",
                "symptoms": "sharp pain, reproducible on palpation",
        ...
        "fatigue": [
            {
                "condition": "Anemia",
                "symptoms": "pale skin, shortness of breath, dizziness",
                "suggestion": "Blood test, iron supplementation if deficient",
            },
            {
                "condition": "Hypothyroidism",
                "symptoms": "weight gain, cold intolerance, dry skin",
                "suggestion": "Thyroid function test, hormone replacement therapy",
            },
            {
                "condition": "Sleep apnea",
                "symptoms": "daytime sleepiness, loud snoring, morning headache",
    ...
    async def __call__(self, action: str, symptom: str = "") -> str:
        if action == "lookup":
            ...
            lines = [
                f"- **{r['condition']}**: {r['symptoms']} → {r['suggestion']}" for r in results
            ]
            return "\n".join(lines)
        elif action == "list":
