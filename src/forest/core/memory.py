...
class AgentMemory:
    ...
    def store(self):
        ...
        if self._store is None:
            from forest.core.memory_store import SQLiteMemoryStore
    ...
    def save_message(self, role: str, content: str) -> None:
        ...
        try:
            ...
            logging.getLogger("forest.memory").warning("save_message failed: %s", exc)
    ...
    def get_long_term_context(self, entity_name: str = "") -> str:
        ...
        try:
            ...
            logging.getLogger("forest.memory").warning("get_long_term_context failed: %s", exc)
            return ""
    ...
    async def extract_facts(self, llm: Any) -> None:
        ...
        try:
            ...
            logging.getLogger("forest.memory").warning("extract_facts failed: %s", exc)
